...
"""Code to run a pose estimation with a TFLite BlazePose model."""
...
class BlazePose(object):
  """A wrapper class for a BlazePose TFLite pose estimation model."""

  def __init__(self, model_name: str) -> None:
    """Initialize a BlazePose pose estimation model.

    Args:
        model_name: Name of the TFLite BlazePose model.
    """
  ...
  def _process_output(self, heatmap_data: np.ndarray,
    ...
    """Post-process the output of BlazePose TFLite model.

    Args:
      heatmap_data: heatmaps output from BlazePose. [height_resolution,
        width_resolution, 17]
      offset_data: offset vectors (XY) output from BlazePose. [height_resolution,
        width_resolution, 34]
